...
CookieBot provides a fun way to reward users who are active on your Discord server. 
...
##
### Development
CookieBot is my first project, so issues may arise. I'm working on it regularly, adding new features, and making sure the bot is stable at all times.
...
Try out CookieBot by clicking the invite [here](https://discord.com/api/oauth2/authorize?client_id=1133155318117957643&permissions=2550523984&scope=applications.commands%20bot).
